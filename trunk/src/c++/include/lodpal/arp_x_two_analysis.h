#ifndef LODPAL_ARP_X_TWO_H
#define LODPAL_ARP_X_TWO_H

//****************************************************************************
//* File:      arp_x_two_analysis.h                                          *
//*                                                                          *
//* Author:    Yeunjoo Song                                                  *
//*                                                                          *
//* History:   Version 0.0 Initial implementation                yjs May. 02 *
//*                                                                          *
//* Notes:     This header file defines ARP_x_two_analysis class.            *
//*                                                                          *
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// ~ Class:     ARP_x_two_analysis                                           ~
// ~                                                                         ~
// ~ Purpose:   Defines two-parameter(lambda2 not fixed)  model              ~
// ~            ARP analysis for X-linked marker.                            ~
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

class ARP_x_two_analysis : public ARP_base_analysis
{
  public:

    ARP_x_two_analysis(lodpal_pairs& pairs, cerrorstream& err = sage_cerr);
