#ifndef LODPAL_ARP_ONE_H
#define LODPAL_ARP_ONE_H

//****************************************************************************
//* File:      arp_one_analysis.h                                            *
//*                                                                          *
//* Author:    Yeunjoo Song                                                  *
//*                                                                          *
//* History:   Version 0.0 Initial implementation                yjs Jul. 01 *
//*                                                                          *
//* Notes:     This header file defines ARP_one_analysis class.              *
//*                                                                          *
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// ~ Class:     ARP_one_analysis                                             ~
// ~                                                                         ~
// ~ Purpose:   Defines one-parameter model ARP(affected relative pair) test.~
// ~                                                                         ~
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

class ARP_one_analysis : public ARP_base_analysis
{
  public:

    ARP_one_analysis(lodpal_pairs& pairs, cerrorstream& err = sage_cerr);
