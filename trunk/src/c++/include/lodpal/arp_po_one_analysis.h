#ifndef LODPAL_ARP_PO_ONE_H
#define LODPAL_ARP_PO_ONE_H

//****************************************************************************
//* File:      arp_po_one_analysis.h                                         *
//*                                                                          *
//* Author:    Yeunjoo Song                                                  *
//*                                                                          *
//* History:   Version 0.0 Initial implementation                yjs Feb. 03 *
//*                                                                          *
//* Notes:     This header file defines ARP_po_one_analysis class.           *
//*                                                                          *
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// ~ Class:     ARP_po_one_analysis                                          ~
// ~                                                                         ~
// ~ Purpose:   Defines one-parameter model                                  ~
// ~            ARP analysis for parent-of-origin test.                      ~
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

class ARP_po_one_analysis : public ARP_base_analysis
{
  public:

    ARP_po_one_analysis(lodpal_pairs& pairs, cerrorstream& err = sage_cerr);
