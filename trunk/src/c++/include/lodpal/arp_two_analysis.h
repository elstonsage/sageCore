#ifndef LODPAL_ARP_TWO_H
#define LODPAL_ARP_TWO_H

//****************************************************************************
//* File:      arp_two_analysis.h                                            *
//*                                                                          *
//* Author:    Yeunjoo Song                                                  *
//*                                                                          *
//* History:   Version 0.0 Initial implementation                yjs Jul. 01 *
//*                                                                          *
//* Notes:     This header file defines ARP_two_analysis class.              *
//*                                                                          *
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// ~ Class:     ARP_two_analysis                                             ~
// ~                                                                         ~
// ~ Purpose:   Defines two-parameter model ARP(affected relative pair) test.~
// ~                                                                         ~
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

class ARP_two_analysis : public ARP_base_analysis
{
  public:

    ARP_two_analysis(lodpal_pairs& pairs, cerrorstream& err = sage_cerr);
