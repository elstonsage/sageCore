...
#include "TransformationSubmodel.h"
#endif
...
TransformationSubmodel::dump(ostream & out) const
{
  ...
  bool lambda_one_fixed = my_parameters[0].initial_type == MAXFUN::Parameter::FIXED;
  bool lambda_two_fixed = my_parameters[1].initial_type == MAXFUN::Parameter::FIXED;
...
//  clone()
//============================================================================
inline MAXFUN::NewSubmodelShPtr 
NewTransformationSubmodel::clone()
{
  return MAXFUN::NewSubmodelShPtr(new NewTransformationSubmodel(*this));
}
...
//============================================================================
inline  
NewTransformationSubmodel::NewTransformationSubmodel(cerrorstream & errors)
  : NewSubmodel("Transformation")
{
  set(box_cox, model_input(QNAN), model_input(QNAN), QNAN, QNAN);
}
...
//============================================================================
inline
NewTransformationSubmodel::NewTransformationSubmodel(const NewTransformationSubmodel & other)
  : NewSubmodel(other)
{
  copy(other);
}
...
// operator=
//============================================================================
inline NewTransformationSubmodel &
NewTransformationSubmodel::operator=(const NewTransformationSubmodel& other)
{
  if(this != &other)
    copy(other);
...
//============================================================================
inline void
NewTransformationSubmodel::copy(const NewTransformationSubmodel& other)
{
  NewSubmodel::operator=(other);
...
//============================================================================
inline
NewTransformationSubmodel::~NewTransformationSubmodel()
{}

//============================================================================
// option
//============================================================================
inline NewTransformationSubmodel::sm_option
NewTransformationSubmodel::option() const
{
  return my_option;
}
...
//============================================================================
inline string  
NewTransformationSubmodel::option_description() const
{
  return option_2_description(my_option);
}
...
//============================================================================
inline string  
NewTransformationSubmodel::name() const
{
  return TRANSFORMATION_NAME;
}
...
//============================================================================
inline string
NewTransformationSubmodel::option_2_description(sm_option opt)
{
  switch(opt)
  {
    case box_cox:       return "Box-Cox";
...
//============================================================================
inline string
NewTransformationSubmodel::option_2_parameter(sm_option opt)
{
  switch(opt)
  {
    case box_cox:       return "box_cox";
...
//============================================================================
inline double
NewTransformationSubmodel::lambda_one() const
{
  return my_lambda_one;
}
...
//============================================================================
inline double
NewTransformationSubmodel::lambda_two() const
{
  return my_lambda_two;
}
...
//============================================================================
inline void
NewTransformationSubmodel::dump(ostream & out) const
{
  int old_precision = out.precision();
...
//=============================================================================
inline double
NewTransformationSubmodel::sign(double value)
{
  return value < 0.0 ? -1.0 : (value == 0.0 ? 0.0 : 1.0);
}
...
//=============================================================================
inline bool
NewTransformationSubmodel::calculate_geom_mean(const std::vector<double>& traits) const
{
  switch(my_option)
  {
    case no_trans:      return true;
...
//=============================================================================
inline void  
NewTransformationSubmodel::bc_transform_power_zero(double G, double& trait) const
{
  if(!SAGE::isnan(trait))
    trait = G * log(trait + lambda_two());
}
...
//=============================================================================
inline void  
NewTransformationSubmodel::bc_transform_power_non_zero
    (double G, double& trait) const
{
  if(!SAGE::isnan(trait))
  {
...
//=============================================================================
inline void  
NewTransformationSubmodel::ge_transform_power_zero
  (double G, double& trait) const
{
  if(!SAGE::isnan(trait))
  {
...
//=============================================================================
inline void  
NewTransformationSubmodel::ge_transform_power_non_zero
    (double G, double& trait) const
{
  if(!SAGE::isnan(trait))
  {
