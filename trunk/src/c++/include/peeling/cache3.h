#ifndef PEELING_CACHE3_H
#define PEELING_CACHE3_H
//
...
//                 yjs Created cache3.h for filtered_subpedigrees     Apr 15 04
//
 ...
 *  accessed by the individual index in the RPED::filtered_subpedigree.
 */
