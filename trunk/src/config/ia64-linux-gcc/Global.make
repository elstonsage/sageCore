...
# AR_CXX      = ar
  ...
  OBJ=.o
  LIB=.a
  LAPACK=-llapack -lblas -lf2c -lgfortran
...
#==========================================================================
# Global Compiler options for GCC(64) on Linux/ia64                     |
#--------------------------------------------------------------------------
  ...
  LDFLAGS    :=-L. -L$(SAGEROOT)/c++/lib -L../lib -L/usr/lib -L/lib -L$(SAGEROOT)/$(EXTERNDIR)/archive/$(ARCH) $(LDFLAGS)
  LDLIBS     := $(LDLIBS) -lieee
  ...
  LINTFLAGS    := -i$(SAGEROOT)/c++/include -i../include \
		  ...
		  -I$(SAGEROOT)/$(EXTERNDIR)/include/python1.5    \
               	  -I/usr/include/boost \
                  -d__ia64__ -d__ia64 -d__linux__ -dia64=1
